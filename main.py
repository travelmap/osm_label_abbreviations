...
def main():
    ...
    parser.add_argument('-l','--language', help='Language to apply. Supported; [catalan, czech, dutch, english, french, german, italian, spanish, swedish, turkish]', required=True)
