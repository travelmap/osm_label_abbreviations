abbreviations = {
    ...
    'danish':[
        ...
        {'match':'^(.{5,})\s+Gade$',	 'replace':'\\1 Gd.',	'concatenated':'no',	'separable':'n/a',	'note':'Street. Example: Ågade, Niels Juels Gade'},
        {'match':'^(.{5,})gade$',	 'replace':'\\1gd.',	'concatenated':'yes',	'separable':'n/a',	'note':'Street. Example: Ågade, Vester Søgade'},
        ...
        {'match':'(^.{5,}|^)Nordre(.{5,})$', 'replace':'\\1Ndr\\2',	'concatenated':'no',	'separable':'n/a',	'note':'Northern. Example: Nordre Sørække, Haveforeningen Nordre Vang'},
        {'match':'^N[oø]+rre\s+',        'replace':'Nre ',	'concatenated':'no',	'separable':'n/a',	'note':'Northern. Example: Nørre voldgade, Nørrebrogade'},
        {'match':'^[OØ]+ster\s+',        'replace':'Ost ',	'concatenated':'no',	'separable':'n/a',	'note':'Southern. Example: Øster voldgade'},
        {'match':'^(.{5,})Plads$',	 'replace':'\\1Pl.',	'concatenated':'no',	'separable':'n/a' ,	'note':'Quare. Example: Enghave Plads, Jernbanepladsen'},
        {'match':'(^.{5,}|^)S[oø]+ndre(.{5,})$', 'replace':'\\1Sdr\\2',	'concatenated':'no',	'separable':'n/a',	'note':'Southern. Example: Søndre Damtoften, Ledøje Søndre Gade'},
        {'match':'(^.{5,}|^)Store\s+',	 'replace':'\\1St. ',	'concatenated':'no',	'separable':'n/a',	'note':'Greater (big). Example: Store Valbyvej, Ishøj Store Torv'},
        {'match':'^(.{5,})\s+Stræde$',	 'replace':'\\1 Str.',	'concatenated':'no',	'separable':'n/a',	'note':'Alley. Example: Steffen Brandts Stræde'},
        {'match':'^(.{5,})Stræde$',	 'replace':'\\1str.',	'concatenated':'yes',	'separable':'n/a',	'note':'Alley. Example: Strædet, Rådhusstræde'},
        {'match':'^Gammel\s+(.{5,})$',	 'replace':'Gl. \\1',	'concatenated':'no',	'separable':'n/a',	'note':'Old. Example: Gammelmosevej, Gammel Roskildevej'},
        {'match':'^(.{5,})\s+Vej$',	 'replace':'\\1 V.',	'concatenated':'no',	'separable':'n/a',	'note':'Way. Example: Andersen Nexø Vej'},
        {'match':'^(.{5,})vej$',	 'replace':'\\1v.',	'concatenated':'yes',	'separable':'n/a',	'note':'Way. Example: Gammel Roskildevej'},
	...
	{'match':'^Beco\s+',		 'replace':'Bc. ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Beco Formosa, Caminho do Beco'},
        ...
        {'match':'\s+Comandante\s+',	 'replace':' Cmdt. ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Rua Comandante Filipe Freire '},
        {'match':'\s+Comendador\s+',	 'replace':' Comend. ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Rua Comendador Lino da Silva'},
        {'match':'\s+Engenheiro\s+',	 'replace':' Engenh. ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Rua Engenheiro Ribeiro da Silva'},
        {'match':'^Escadas\s+',		 'replace':'Esc ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Escadas do Poço Novo  '},
        {'match':'^Estrada\s+',		 'replace':'Estr ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Estrada Real, EM 522 - Estrada da Várzea, Rua Estrada da Meirinha'},
        {'match':'^Largo\s+',		 'replace':'Lg. ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Largo das Palmeiras'},
        {'match':'^Praça\s+',		 'replace':'Pç ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Rua Afonso Praça, Praça da Varzinha'},
        {'match':'^Praceta\s+',		 'replace':'Pct ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Praceta das Eiras'},
        {'match':'^Primeiro\s+',	 'replace':'Prim.',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Rua Primeiro de Maio'},
        {'match':'^Rua\s+',		 'replace':'R ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Beco da Rua da Forca, Rua da Paz'},
        {'match':'^Travessa\s+',	 'replace':'Trav. ',	'concatenated':'no',	'separable':'n/a',	'note':'Example: Travessa do Gil, Caminho das Travessadas'}
    ],
    'russian':[
	...
	{'match':'\s+аллея(\s+|^)',	     'replace':' ал.\\1',	'concatenated':'no',	'separable':'n/a',	'note':'alleya - alley. Example: Роскошная аллея, Липовая аллея (3-я)'},
        ...
        {'match':'(^|\s+)переулок(\s+|$)',   'replace':'\\1пер.\\1',	'concatenated':'no',	'separable':'n/a',	'note':'pereulok - lane. Example: Мароновский переулок, переулок Ватутина'},
        {'match':'(^|\s+)площадь(\s+|$)',    'replace':'\\1пл.\\1',	'concatenated':'no',	'separable':'n/a',	'note':'ploshchad\' - square. Example: Лялина площадь, площадь Гагарина'},
        {'match':'^проезд\s+',		     'replace':'пр. ',		'concatenated':'no',	'separable':'n/a',	'note':'proyezd - passage. Example: проезд Шишкина, проезд'},
        {'match':'\s+проезд(\s+|$)',	     'replace':' пр.\\1',	'concatenated':'no',	'separable':'n/a',	'note':'proyezd - passage. Example: Карелин проезд, 1-й проезд, Проектируемый проезд № 5265'},
        {'match':'^проспект\s+',	     'replace':'просп. ',	'concatenated':'no',	'separable':'n/a',	'note':'prospekt - avenue. Example: проспект Шмидта'},
        {'match':'\s+проспект(\s+|$)',	     'replace':' просп.\\1',	'concatenated':'no',	'separable':'n/a',	'note':'prospekt - avenue. Example: Союзный проспект, Рязанский проспект (дублёр)'},
        {'match':'\s+шоссе(\s+|$)',	     'replace':' ш.\\1',	'concatenated':'no',	'separable':'n/a',	'note':'shosse - highway. Example: Карачаровское шоссе, Шоссейная улица, Боровское шоссе (дублёр)'},
        {'match':'(^|\s+)тупик(\s+|$)',	     'replace':'\\1туп.\\1',	'concatenated':'no',	'separable':'n/a',	'note':'tupik - dead end street. Example: Сыровский тупик, тупик Чернышевского'},
        {'match':'^улица\s+',		     'replace':'ул. ',		'concatenated':'no',	'separable':'n/a',	'note':'ulitsa - street. Example: улица Шама'},
        {'match':'\s+улица(\s+|$)',	     'replace':' ул.\\1',	'concatenated':'no',	'separable':'n/a',	'note':'ulitsa - street. Example: Педагогическая улица, Липецкая улица (дублёр)'}
    ],
    'spanish':[
